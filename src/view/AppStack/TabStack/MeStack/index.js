 ...
 * @Last Modified time: 2019-04-28 13:43:50
 */
...
import icon from '../../../../static/images/tabbar/mine.png';
import activeIcon from '../../../../static/images/tabbar/mine-choose.png';
...
HomeStack.navigationOptions = ({ navigation, screenProps }) => {
  const { i18n: { root_app_tabs_me: tabBarLabel } } = screenProps;
